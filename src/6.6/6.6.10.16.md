...
*  [#15489 - Order cancellation only shown for open orders](https://github.com/shopware/shopware/blob/v6.6.10.16/changelog/release-6-6-10-16/2026-03-30-order-cancellation-only-shown-for-open-orders.md)
...
*  [#11895 - Improve admin search indexing event handling and iterator versioning](https://github.com/shopware/shopware/blob/v6.6.10.16/changelog/release-6-6-10-16/2025-08-15-reduce-admin-es-indexing-and-iterator-versioning.md)
...
*  [#4053 - Adds MIN() Function to cheapestPrice Accessor](https://github.com/shopware/shopware/blob/v6.6.10.16/changelog/release-6-6-10-16/2025-07-11-fix-correctly-sort-product-variants-with-different-prices.md)
*  [#15269 - PromotionRedemptionUpdater performance](https://github.com/shopware/shopware/issues/15269)
*  [#15581 - Fix race condition between cart persist and load](https://github.com/shopware/shopware/blob/v6.6.10.16/changelog/release-6-6-10-16/2026-03-13-fix-race-condition-cart-persist-and-load.md)
...
*  [#15419 - Fix invoice number selection for credit notes and storno invoices](https://github.com/shopware/shopware/blob/v6.6.10.16/changelog/release-6-6-10-16/2025-06-27-fix-invoice-number-selection.md)
