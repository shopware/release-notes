...
The maintenance configuration of Sales Channels is now honored in headless store-api requests. When the maintenance mode is active, you will receive a 503 HTTP error in response.
