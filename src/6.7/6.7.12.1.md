...
We kept the regular release cycle to avoid disrupting continuous integration and versioning for our community. To see everything that has changed since the last patch version before v6.7.12.0, please read the full list of changes for [v6.7.12.0](https://github.com/shopware/shopware/releases/tag/v6.7.12.0).
...
* [Detailed diff on Github](https://github.com/shopware/shopware/compare/v6.7.11.1...v6.7.12.1) to the former version
